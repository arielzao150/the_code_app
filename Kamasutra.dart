...
class Kamasutra extends Criptografia {
  final String explicacao = """Essa criptografia gera uma lista com 26 letras do alfabeto sem repetição e depois divide a lista em e 2 linhas de 13 letras em cada. Feito isso, ela procura cada letra do texto digitado e a substitui pela letra que possui a mesma posição que ela na outra fileira""";
  final String nome = "Kamasutra";
  final Nivel nivel = Nivel.BASICO;
  final String keyKS = RandomAlphaNoDuplicate(26);

  @override
  State<StatefulWidget> createState() => _KamasutraState(explicacao, nome, keyKS);
...
class _KamasutraState extends State<Kamasutra> {
  ...
  _KamasutraState(this.explicacao, this.nome, this.keyKS);
